...
export default function Education() {
  return (
    <section id="education" className="scroll-mt-28 max-w-[50rem] text-center leading-8 mx-auto mb-16">
      ...
      <div className="relative pl-20 text-left mt-12">
        {/* Logo circle */}
        <div className="absolute left-0 top-0 w-[74px] h-[74px] bg-white border-2 border-gray-200 rounded-full flex items-center justify-center dark:bg-gray-800 dark:border-gray-700 shadow-md overflow-hidden">
          <a
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <h3 className="text-xl font-bold mb-1">B.Sc. Business Informatics (Wirtschaftsinformatik)</h3>
          <p className="mb-3">
          ...
          <div className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed list-disc space-y-1 mb-1">
